...
with st.sidebar:
    ...
    st.image("https://asset.kompas.com/crops/AgRYtH1OCPWxS-YlnLNTkrz3N5Q=/0x123:788x649/1200x800/data/photo/2018/08/30/3194492752.png")
...
st.subheader("Jumlah Penjualan perusahaan dalam beberapa tahun terakhir")
...
st.subheader("Jam berapa yang paling banyak dan paling sedikit disewa ?")
...
st.pyplot(fig)
st.subheader("Musim apa sepeda yang paling banyak disewa?")
...
st.caption('Copyright (c) Tunggul Randriawan 2024')
