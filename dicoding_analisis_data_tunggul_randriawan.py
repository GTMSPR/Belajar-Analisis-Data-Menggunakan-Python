# -*- coding: utf-8 -*-
"""Dicoding_Analisis Data_Tunggul Randriawan.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15e8s9DYKFzZQVSbd8iUjNzNDitZ1EpEC

# Proyek Analisis Data: Bike Sharing Dataset
- **Nama : Tunggul Randriawan**
- **Email : andresigultom@gmail.com**
- **ID Dicoding : tunggul_randriawan**

Pertanyaan
1. Berapa Jumlah Penyewa sesuai Cuaca yang terjadi?
2. Berapakah Jumlah Seluruh Penyewa dalam Beberapa Bulan/Tahun Terakhir?

## Mengimport library yang diperlukan terlebih dahulu
"""
